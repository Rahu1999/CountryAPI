...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.region.setText(mainData.get(position).getRegion());
        holder.subRegion.setText(mainData.get(position).getSubregion());
        holder.population.setText(String.valueOf(mainData.get(position).getPopulation()));
        holder.language.setText(mainData.get(position).getLanguages());
        holder.borders.setText(mainData.get(position).getBorders());
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        ...
        TextView region, subRegion, population, borders, language;
        public MyHolder(@NonNull View itemView) {
            ...
            language = (TextView) itemView.findViewById(R.id.Languages);
        }
    }
}
